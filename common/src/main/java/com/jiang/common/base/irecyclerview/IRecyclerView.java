package com.jiang.common.base.irecyclerview;
...
public class IRecyclerView extends RecyclerView {
    ...
    public void setLoadMoreFooterView(@LayoutRes int loadMoreFooterLayoutRes) {
        ensureLoadMoreFooterContainer();
        final View loadMoreFooter = LayoutInflater.from(CommonApplication.getAppContext())
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    Log.e(TAG, "Error processing scroll; pointer index for id "
                            + index + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
    ...
    private Animator.AnimatorListener mAnimationListener = new SimpleAnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (DEBUG) {
                Log.i(TAG, "onAnimationEnd " + getStatusLog(lastStatus) + " -> "
                        + getStatusLog(mStatus) + " ;refresh view height:"
