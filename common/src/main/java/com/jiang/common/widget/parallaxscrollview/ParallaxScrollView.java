package com.jiang.common.widget.parallaxscrollview;
 ...
 */
public class ParallaxScrollView extends PullToZoomBase<ScrollView> {
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * ParallaxScrollView.sInterpolator.getInterpolation(f1);
